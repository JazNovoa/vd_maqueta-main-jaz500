...
<style>
    :global(body) {
        ...
        overflow: hidden; /* Evita el desplazamiento en el cuerpo */
    }
    ...
    .container {
        ...
        scroll-behavior: smooth; /* Agrega desplazamiento suave */
    }
...
<script>
    ...
    document.addEventListener('wheel', (event) => {
        if (event.deltaY !== 0) {
            ...
            document.querySelector('.container').scrollLeft += event.deltaY; // Desplaza horizontalmente
        }
    });
</script>
