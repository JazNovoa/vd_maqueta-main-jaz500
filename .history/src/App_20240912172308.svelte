...
<style>
    ...
    .scrollable-content {
        ...
        flex-direction: row;
        overflow-x: auto;
        align-items: center; /* Asegura que todo en scrollable-content esté centrado verticalmente */
        width: 100vw;
    }
    ...
    .title-container {
        ...
        padding: 20px 0; /* Añade algo de espacio alrededor del texto */
    }
    ...
    .chart {
        ...
        margin: 20px auto; /* Centra la gráfica horizontalmente y añade espacio vertical */
    ...
    .item_wrapper {
        ...
        align-items: center;
        width: 200px; /* Asegura que cada ítem tenga un ancho específico */
    }
    ...
    .image-group {
        display: flex;
        flex-direction: column;
        align-items: center; /* Centra las imágenes en su contenedor */
        gap: 10px;
    }
    ...
    .image-left, .image-right {
        ...
        display: flex;
        flex-direction: column;
        align-items: center; /* Centra los elementos dentro de cada imagen */
    }
