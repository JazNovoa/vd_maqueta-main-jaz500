...
<div class="scrollable-wrapper">
    ...
    <!-- Sección que se desplaza horizontalmente -->
...
.scrollable-wrapper {
    display: flex;
    flex-direction: column; /* El título y el contenido desplazable estarán en columnas */
...
.scrollable-content {
    display: flex;
    flex-direction: row; /* Organiza el texto y el gráfico en una fila */
...
.description-section {
    ...
    margin-right: 20px; /* Espacio entre el texto y el gráfico */
}
...
/* Sección del gráfico */
.chart-section {
    flex: 1; /* Permite que la sección del gráfico ocupe el espacio restante */
}
