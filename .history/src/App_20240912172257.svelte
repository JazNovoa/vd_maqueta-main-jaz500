...
<style>
  .scrollable-content {
    ...
    align-items: center; /* Centra verticalmente los contenidos en el contenedor */
    justify-content: center; /* Centra horizontalmente los contenidos inicialmente */
    height: 100vh; /* Altura que ocupa toda la pantalla */
    background-color: #312783; /* Fondo de color oscuro */
}
...
.container {
    ...
    min-width: 100vw; /* Asegura un ancho mínimo del contenedor */
    align-items: center; /* Asegura que el contenido interno esté centrado verticalmente */
    justify-content: flex-start; /* Alinea el contenido a la izquierda después del título */
}

.chart {
    display: flex;
    justify-content: space-between;
    align-items: center; /* Asegura que los items estén centrados verticalmente */
...
.item_wrapper {
    ...
    justify-content: center; /* Centra los elementos internamente */
}
