...
<style>
  .scrollable-content {
    ...
    background-color: #312783; /* Color de fondo */
}
...
.container {
    ...
    padding-left: 50px; /* Deja un espacio al inicio para el título */
}

.chart {
    display: flex;
    justify-content: space-between;
    align-items: flex-end; /* Alinea los gráficos desde la parte inferior */
    gap: 50px; /* Espacio entre los elementos */
}
...
.item_wrapper {
    ...
    align-items: center; /* Centra cada grupo de elementos */
    justify-content: center;
    min-width: 200px; /* Ancho mínimo de cada grupo */
}
